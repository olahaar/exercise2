...
- Install dependencies: `npm install` inside `exercise2/2_2`.
...
- [public/app.jsx](public/app.jsx): React UI (loaded via Babel in the browser).
...
- R28 Visual distinction: Reflection area uses a separate card tone and dashed border in [public/styles.css](public/styles.css) (the `.reflection` block rendered by [public/app.jsx](public/app.jsx)).
